...
$kendaraan1 = new Kendaraan("Sigra", "Mobil", 4, "Suzuki", "Premium", 100000000, 1996);
...
$kendaraan2 = new Kendaraan("Kijang Innova New Venturer", "Mobil", 4, "Suzuki", "Pertamax", 400000000, 2021);
